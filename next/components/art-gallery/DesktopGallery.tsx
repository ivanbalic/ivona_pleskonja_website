  ...
  return (
    ...
    >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Image
                ...
                alt={selected.ALT}
                className={cn("max-h-full object-cover", selected.CLASS_NAME)}
                placeholder="blur"
              />
            </motion.div>
          </AnimatePresence>
      ...
      >
        <div
          className={cn(
            "flex flex-1 flex-col justify-end items-start text-primaryBlue tracking-[.15em]",
          )}
        >
          <AnimatePresence mode="wait">
            <motion.div
            ...
            >
              ...
              {selected.TYPE === "vertical" && (
                <div className="text-[32px] leading-[100%] font-bold font-roboto-serif mt-[5px]">
                  {
