...
export const seoConfig: SeoConfig = {
  default: {
    ...
    description:
      "Ivona Pleskonja – A contemporary Serbian artist specializing in mixed media, murals, and installations. Her work blends traditional craftsmanship with modern techniques.",
    keywords: [
      "contemporary art",
      "Serbian artist",
      "mixed media",
    ...
    openGraph: {
      ...
      description:
        "Ivona Pleskonja – A contemporary Serbian artist specializing in mixed media, murals, and installations.",
      url: baseUrl,
      images: [
        {
    ...
    twitter: {
      ...
      title: "Ivona Pleskonja - Contemporary Serbian Artist",
      description:
        "Contemporary Serbian artist specializing in mixed media, murals, and installations.",
